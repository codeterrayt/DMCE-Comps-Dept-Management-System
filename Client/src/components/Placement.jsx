...
const Placement = () => {
    ...
    return (
        <section className='w-full min-h-screen p-4 md:p-8'>
            {loader ? (
                <Loaders message="Loading your placement details..." />
            ) : (
                                        ...
                                        {placement.map((row, rowIndex) => (
                                            <tr key={rowIndex}>
                                                ...
                                                <td className='text-center text-sm'>
                                                    <a href={row.offer_letter} target="_blank" rel="noopener noreferrer">View Offer Letter</a>
                                                </td>
                                                <td className='text-center text-sm'>{row.package}</td>
                                                ...
                                                <td className='text-center text-sm'>
                                                    <div className='flex items-center justify-center gap-2'>
                                                        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => handleEdit(row)}><i className="fa-solid fa-pen-to-square"></i></button>
